...
RatchetExamples loves to welcome your contributions. There are several ways to help out:
...
RatchetExamples tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

    ./lib/Cake/Console/cake test RatchetExamples AllRatchetExamples

To run the sniffs for CakePHP coding standards

    phpcs -p --extensions=php --standard=CakePHP ./app/Plugin/RatchetExamples
...
* [Bug tracker](https://github.com/WyriHaximus/RatchetExamples/issues)
